...
static osTimerId TimId_Running;         /* Timer ID for timer running in ISR  */
static volatile osTimerId TimId_Isr;    /* Timer ID returned from the ISR     */
static volatile osStatus  TimSt_Isr;    /* Status returned from the ISR       */
